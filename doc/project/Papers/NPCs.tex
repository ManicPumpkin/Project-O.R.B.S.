...
\label{subsubsec:bosse}
	\begin{itemize}
		...
		\item harte Bosse können nur durch gewisse Strategien besiegt werden (z.B. Man muss den Boss zu Fall bringen und ihm auf den Kopf kloppen)
	\end{itemize}

\subsection{\textit{Pets}}
\label{subsec:pets}
	\textit{\begin{itemize}
		\item eventuell Mounts zum Reiten und Fliegen
	\end{itemize}}